...
public:
	...
	*/
	...
	// Get & Set
	int obtener_registro_RL(int numero_nucleo) const;

	void guardar_registro_RL(int numero_nucleo, int valor);

	int obtener_bloque_candado_RL(int numero_nucleo) const;

	void guardar_bloque_candado_RL(int numero_nucleo, int numero_bloque);

	bool obtener_bandera(int numero_nucleo) const;
...
private:
	...
	// Métodos auxiliares
	void obtener_bus_cache_datos(int numero_nucleo);

	void liberar_bus_cache_datos();

	void obtener_cache_foranea(int indice_cache);
